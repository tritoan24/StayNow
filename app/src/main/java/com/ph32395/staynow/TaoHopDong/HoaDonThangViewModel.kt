...
//    contract: com.ph32395.staynow.TaoHopDong.HopDong,
//    utilityFees: List<com.ph32395.staynow.TaoHopDong.UtilityFee>
...
//        val fixedUtilityDetails: List<com.ph32395.staynow.TaoHopDong.UtilityFeeDetail>
//
//        if (isFullMonth) {
...
//                    else -> 1
//                }
//                com.ph32395.staynow.TaoHopDong.UtilityFeeDetail(
//                    name = fee.name,
...
//    invoiceId: String,
//    variableFees: List<com.ph32395.staynow.TaoHopDong.UtilityFeeDetail>,
//    onSuccess: () -> Unit,
//    onFailure: (Exception) -> Unit
//) {
//    viewModelScope.launch {
...
//                    "status" to com.ph32395.staynow.TaoHopDong.InvoiceStatus.PENDING.name
//                )
//            ).await()
//
//            onSuccess()
