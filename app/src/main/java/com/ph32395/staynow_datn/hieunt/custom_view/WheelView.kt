package com.ph32395.staynow_datn.hieunt.custom_view
...
open class WheelView @JvmOverloads constructor(
     ...
     * 字体大小
     */
    private var selectedItemTypeface: Typeface? = null
    private var normalItemTypeface: Typeface? = null
    ...
    private fun initAttrsAndDefault(context: Context, attrs: AttributeSet?) {
        ...
        selectedItemTypeface = ResourcesCompat.getFont(context, ta.getResourceId(R.styleable.WheelView_wv_selectedItemFont, R.font.inter_semi_bold))
        normalItemTypeface = ResourcesCompat.getFont(context, ta.getResourceId(R.styleable.WheelView_wv_normalItemFont, R.font.inter_regular))
    ...
    private fun drawItem(canvas: Canvas, index: Int, scrolledOffset: Int) {
        ...
        paint.typeface = if (isInactive(index)) normalItemTypeface else selectedItemTypeface
    }
