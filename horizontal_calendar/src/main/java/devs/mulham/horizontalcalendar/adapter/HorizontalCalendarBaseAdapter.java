...
public abstract class HorizontalCalendarBaseAdapter<VH extends DateViewHolder, T extends Calendar> extends RecyclerView.Adapter<VH> {
    ...
    protected void applyStyle(VH viewHolder, boolean isSelect) {
        if (isSelect) {
            viewHolder.textTop.setTextColor(Color.parseColor("#1F2937"));
            viewHolder.textMiddle.setTextColor(Color.parseColor("#1F2937"));
            viewHolder.textBottom.setTextColor(Color.parseColor("#1F2937"));
            viewHolder.viewSelect.setVisibility(View.VISIBLE);
        } else {
            viewHolder.textTop.setTextColor(Color.parseColor("#9CA3AF"));
            viewHolder.textMiddle.setTextColor(Color.parseColor("#9CA3AF"));
            viewHolder.textBottom.setTextColor(Color.parseColor("#9CA3AF"));
            viewHolder.viewSelect.setVisibility(View.GONE);
        }
    }
